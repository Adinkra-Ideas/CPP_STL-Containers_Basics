...
/*   Updated: 2023/03/04 20:59:48 by euyi             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void print(const NS::vector<std::string>& v) {
...
int main()
{
	...
	NS::vector<std::string> obj2(obj.begin(), obj.end());
	std::cout << "obj2: " << std::endl;
	print(obj2);

	NS::vector<std::string> obj3(obj2);
	...
	NS::vector<std::string>::iterator it = obj3.begin();
	for (; it < obj3.end(); it++) {
		std::cout << "it: " << *it << " ";
	}
	std::cout << std::endl;

	NS::vector<std::string>::reverse_iterator rvrIt = obj3.rbegin();
