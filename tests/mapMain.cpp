...
/*   Updated: 2023/03/04 21:05:41 by euyi             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void print(const NS::map<std::string, int>& m) {
	std::cout << '{';
	NS::map<std::string, int>::const_iterator b = m.begin();
	NS::map<std::string, int>::const_iterator e = m.end();
	while (b != e) {
...
int main()
{
	...
	NS::map<std::string, int> mp2(mp1.find("something"), mp1.end());
	std::cout << "mp2: " << std::endl;
	print(mp2);

	NS::map<std::string, int> mp3(mp1);
	...
	NS::map<std::string, int>::reverse_iterator rvrIt = mp3.rbegin();
	std::cout << '{';
